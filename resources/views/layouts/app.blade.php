        ...
        <aside class="w-56 min-h-screen bg-[#2a1020] flex flex-col fixed top-0 left-0 z-30">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1">
                ...
                @if(Auth::user()->tipo_usuario === 'Funcionario')
                    ...
                    {{ request()->routeIs('funcionario.clientes.*') ? 'bg-[#550000] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                            ...
                            <a href="{{ route('funcionario.historial.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                                {{ request()->routeIs('funcionario.historial.*') ? 'bg-[#550000] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('funcionario.notificaciones.index') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                                {{ request()->routeIs('funcionario.notificaciones.*') ? 'bg-[#550000] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @else
                    ...
                    <a href="{{ route('cliente.tramite') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                        {{ request()->routeIs('cliente.tramite') ? 'bg-[#550000] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                    ...
                    <a href="{{ route('cliente.documentos') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                        {{ request()->routeIs('cliente.documentos*') ? 'bg-[#550000] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
